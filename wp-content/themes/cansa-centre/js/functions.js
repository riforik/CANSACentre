...
(function($) {
	...
	(function() {
		...
		menuToggle.on('click.cansaCentre', function() {
	...
	(function() {
		...
		function toggleFocusClassTouchScreen() {
			if (window.innerWidth >= 910) {
				$(document.body).on('touchstart.cansaCentre', function(e) {
					if (!$(e.target).closest('.main-navigation li').length) {
						$('.main-navigation li').removeClass('focus');
					}
				});
				siteNavigation.find( '.menu-item-has-children > a, .page_item_has_children > a' ).on( 'touchstart.cansaCentre', function( e ) {
				...
				siteNavigation.find('.menu-item-has-children > a').off('touchstart.cansaCentre');
			}
		}

		if ('ontouchstart' in window) {
			$(window).on('resize.cansaCentre', toggleFocusClassTouchScreen);
			toggleFocusClassTouchScreen();
		}

		siteNavigation.find('a').on('focus.cansaCentre blur.cansaCentre', function() {
	...
	$(document).ready(function() {
		$(window).on('load.cansaCentre resize.cansaCentre', function() {
			if (window.innerWidth < 910) {
