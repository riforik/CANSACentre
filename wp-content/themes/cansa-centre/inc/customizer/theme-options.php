...
class CansaCentre_Theme_Options {
	...
	public function add_defaults( $default_options ) {
		$defaults = array(
			...
			'deneb_excerpt_more_text' => esc_html__( 'Continue reading', 'cansa-centre' ),

			// Homepage/Frontpage Options.
			'deneb_front_page_category'   => '',
			
			// Search Options.
			'deneb_search_text'         => esc_html__( 'Search...', 'cansa-centre' ),
		);
	...
	public function add_panel( $wp_customize ) {
		 ...
		 */
		 $wp_customize->add_panel( 'deneb_theme_options',
		 	array(
				'title' => esc_html__( 'Theme Options', 'cansa-centre' ),
			)
		);
	}
	...
	public function register_breadcrumb_options( $wp_customize ) {
		...
		$wp_customize->add_section( 'deneb_breadcrumb_options',
			array(
				'title' => esc_html__( 'Breadcrumb', 'cansa-centre' ),
		...
		if ( function_exists( 'bcn_display' ) ) {
			CansaCentre_Customizer_Utilities::register_option(
				array(
					...
					'description'       =>  sprintf( esc_html__( 'Since Breadcrumb NavXT Plugin is installed, edit plugin\'s settings %1$shere%2$s', 'cansa-centre' ), '<a href="' . esc_url( get_admin_url( null, 'options-general.php?page=breadcrumb-navxt' ) ) . '" target="_blank">', '</a>' ),
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'label'             => esc_html__( 'Display Breadcrumb?', 'cansa-centre' ),
	...
	public function register_layout_options( $wp_customize ) {
		...
		$wp_customize->add_section( 'deneb_layouts',
			array(
				'title' => esc_html__( 'Layouts', 'cansa-centre' ),
				'panel' => 'deneb_theme_options'
			)
		);
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'label'             => esc_html__( 'Site Layout', 'cansa-centre' ),
				'section'           => 'deneb_layouts',
				'choices'           => array(
					'fluid' => esc_html__( 'Fluid', 'cansa-centre' ),
					'boxed' => esc_html__( 'Boxed', 'cansa-centre' ),
				),
			)
		);
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'sanitize_callback' => 'deneb_sanitize_select',
				'label'             => esc_html__( 'Default Layout', 'cansa-centre' ),
				'section'           => 'deneb_layouts',
				'choices'           => array(
					'right-sidebar'         => esc_html__( 'Right Sidebar', 'cansa-centre' ),
					'no-sidebar-full-width' => esc_html__( 'No Sidebar: Full Width', 'cansa-centre' ),
				),
			)
		);
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'sanitize_callback' => 'deneb_sanitize_select',
				'label'             => esc_html__( 'Homepage/Archive Layout', 'cansa-centre' ),
				'section'           => 'deneb_layouts',
				'choices'           => array(
					'right-sidebar'         => esc_html__( 'Right Sidebar', 'cansa-centre' ),
					'no-sidebar-full-width' => esc_html__( 'No Sidebar: Full Width', 'cansa-centre' ),
	...
	public function register_excerpt_options( $wp_customize ) {
		...
		$wp_customize->add_section( 'deneb_excerpt_options',
			array(
				'title' => esc_html__( 'Excerpt Options', 'cansa-centre' ),
				'panel' => 'deneb_theme_options',
			)
		);
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'label'             => esc_html__( 'Excerpt Length (Words)', 'cansa-centre' ),
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'sanitize_callback' => 'sanitize_text_field',
				'label'             => esc_html__( 'Excerpt More Text', 'cansa-centre' ),
				'section'           => 'deneb_excerpt_options',
			)
		);
	}
	...
	public function register_homepage_options( $wp_customize ) {
		CansaCentre_Customizer_Utilities::register_option(
			array(
				'custom_control'    => 'CansaCentre_Dropdown_Select2_Custom_Control',
				'sanitize_callback' => 'deneb_text_sanitization',
				'settings'          => 'deneb_front_page_category',
				'description'       => esc_html__( 'Filter Homepage/Blog page posts by following categories', 'cansa-centre' ),
				'label'             => esc_html__( 'Categories', 'cansa-centre' ),
				'section'           => 'static_front_page',
				'input_attrs'       => array(
					'multiselect' => true,
				),
				'choices'           => array( esc_html__( '--Select--', 'cansa-centre' ) => CansaCentre_Customizer_Utilities::get_terms( 'category' ) ),
			)
		);
	}
	...
	public function register_search_options( $wp_customize ) {
		...
		$wp_customize->add_section( 'deneb_search',
			array(
				'title' => esc_html__( 'Search', 'cansa-centre' ),
				'panel' => 'deneb_theme_options',
			)
		);
		...
		CansaCentre_Customizer_Utilities::register_option(
			array(
				...
				'sanitize_callback' => 'deneb_text_sanitization',
				'label'             => esc_html__( 'Search Text', 'cansa-centre' ),
 ...
 * Initialize class
 */
$deneb_theme_options = new CansaCentre_Theme_Options();
