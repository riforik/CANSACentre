<?php
/**
 * CansaCentre Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class CansaCentre_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class CansaCentre_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->button_labels = wp_parse_args( $this->button_labels,
				array(
					'add' => esc_html__( 'Add', 'cansa-centre' ),
				)
			);
		}
	 ...
	 */
	class CansaCentre_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class CansaCentre_Note_Control extends WP_Customize_Control {
	 ...
	 *
	 */
	class CansaCentre_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
